import"./tailwind-FG0q2sUH.js";import{g as i}from"./index-LZz_RBWS.js";import{g as s,a as d}from"./getNode-pa7syr6m.js";import{a as m}from"./insert-c9FKGVoP.js";import{C as u}from"./delay-L14dHocY.js";import{c as h}from"./Modal-LwrVZ11o.js";import{c as b}from"./clear-vWyKvuJ4.js";import{c as f}from"./comma-f4do0chS.js";import{c as x}from"./checkAuth-CTdHH8Oq.js";const c=new u("https://suppose-weather.pockethost.io/"),o=s(".content");function w(t){const e=t.target.closest(".heartContainer");if(e){const a=e.querySelector(".heart-bg"),r=a.nextElementSibling;let n=Number(r.innerText)||0;a.classList.contains("bg-heart-icon")?(n+=1,a.classList.add("bg-heart-full-icon"),a.classList.remove("bg-heart-icon")):(n=Math.max(n-1,0),a.classList.remove("bg-heart-full-icon"),a.classList.add("bg-heart-icon")),r.innerText=n}}async function v(){if(!x())return;const t=await c.collection("selling").getFullList("pb/collections/selling");b(o),t.forEach(e=>{const a=e.tradingType==="nanum"?'<span class="text-label-sm text-white rounded-[4px] gap-2 grow bg-no-repeat py-[2px] px-1 bg-secondary">나눔</span>':"";o.insertAdjacentHTML("afterbegin",`
