import"./tailwind-FG0q2sUH.js";import{S as y}from"./swiper-core-xIVJDqhu.js";import{g as v}from"./index-LZz_RBWS.js";import{a as u,g as S}from"./getNode-pa7syr6m.js";import{i as g}from"./insert-c9FKGVoP.js";import{c as f}from"./clear-vWyKvuJ4.js";import{p as m}from"./delay-L14dHocY.js";import{c as $}from"./checkAuth-CTdHH8Oq.js";import"./Modal-LwrVZ11o.js";new y(".swiper",{slidesPerView:"auto",spaceBetween:12,freeMode:!0});const d={interestsState:"all",filter:"filterAll"};let p="-created";function C(){return`<li>
  <div
...
</li>`.repeat(7)}function k(e){const{category:t,date:a,id:r,members:h,isOpen:b,title:x,owner:_,created:w}=e;let{maxMember:n,gender:s,age:l}=e,i="모집중",c="bg-secondary";return n==="제한없음"&&(i="상시모집",c="bg-orange-400"),b||(i="모집완료",c="bg-bluegray-300"),n=n==="제한없음"?n:`${n}명`,s=s==="누구나"?`${s} 참여가능`:`${s}만 참여가능`,l=l==="모든 연령"?l:`${l}대`,`
