import"./tailwind-hLRvZ190.js";import{c as b,g as h}from"./index-dUkrqALE.js";import{g as m}from"./getNode-pa7syr6m.js";import{i as g}from"./insert-c9FKGVoP.js";import{c as x}from"./clear-vWyKvuJ4.js";import{p as n}from"./delay-L14dHocY.js";import{c as f}from"./Modal-LwrVZ11o.js";function p(t){return t.scrollTop=t.scrollHeight}(async function(){if(!b())return;const e=new URL(window.location.href).searchParams.get("id"),a=await n.collection("chatroom").getOne(e,{fields:"members"});(!e||a.members.indexOf(n.authStore.model.id)<0)&&(alert("잘못된 접근입니다."),window.location.href="/src/pages/main/"),await y(),p(m("main")),n.collection("chatroom").subscribe(e,({action:o,record:s})=>{const{members:i}=s,l=s.messageBox.pop(),r=m("#member-count");if(r.textContent=i.length,l.senderId!==n.authStore.model.id){const c=u([l]);g("#message-box",c),p(m("main"))}})})();function u(t){const e=[];return t.length===0?`
