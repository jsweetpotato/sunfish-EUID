import"./tailwind-Jlr4NQan.js";import{g as v}from"./index-LZz_RBWS.js";import{g as p}from"./getNode-pa7syr6m.js";import{i as g}from"./insert-c9FKGVoP.js";import{c as x}from"./clear-vWyKvuJ4.js";import{p as o,c as y}from"./delay-YOOEtQ5Y.js";import{c as w}from"./comma-f4do0chS.js";import{c as $}from"./checkAuth-1jN6PZSr.js";function m(e){return e.scrollTop=e.scrollHeight}(async function(){if(!$())return;const t=new URL(window.location.href).searchParams.get("id"),a=await o.collection("chatroom").getOne(t,{fields:"members, originType"});(!t||a.members.indexOf(o.authStore.model.id)<0)&&(alert("잘못된 접근입니다."),window.location.href="/src/pages/main/"),await L(a.originType),m(p("main")),o.collection("chatroom").subscribe(t,({action:r,record:n})=>{const{members:l,originType:s}=n,i=n.messageBox.pop();let d;if(s==="together"&&(d=p("#member-count"),d.textContent=l.length),i.senderId!==o.authStore.model.id){const c=b([i]);g("#message-box",c),m(p("main"))}})})();function b(e){const t=[];return e.length===0?`
