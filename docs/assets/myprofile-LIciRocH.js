import"./tailwind-GolohDhN.js";import{g as a}from"./getNode-pa7syr6m.js";import{p as m}from"./delay-YOOEtQ5Y.js";import{c as b}from"./checkAuth-1jN6PZSr.js";b();const g=localStorage.getItem("pocketbase_auth"),e=JSON.parse(g),s=a("#profile"),t=a("#aboutMe"),u=a("#sellingProduct"),c=await m.collection("users").getOne(e.model.id,{fields:"avatar, name, period, job, company, introduce, userCord, sellingProductCount"}),{name:n,period:l,job:o,company:r,introduce:x,userCord:p,sellingProductCount:f}=c;function $(d,i="photo"){return`https://suppose-weather.pockethost.io//api/files/users/${e.model.id}/${d[i]}`}e.model.avatar===""?s.insertAdjacentHTML("afterbegin",`
    <img
