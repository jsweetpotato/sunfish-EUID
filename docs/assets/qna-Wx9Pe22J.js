import"./tailwind-hLRvZ190.js";import{S as x}from"./swiper-core-xIVJDqhu.js";import{c as h,g as w}from"./index-dUkrqALE.js";import{a as b,g as v}from"./getNode-pa7syr6m.js";import{i as o}from"./insert-c9FKGVoP.js";import{c as i}from"./clear-vWyKvuJ4.js";import{p as d}from"./delay-L14dHocY.js";import"./Modal-LwrVZ11o.js";new x(".swiper",{slidesPerView:"auto",spaceBetween:12,freeMode:!0});const g={interestsState:"all"};let l="-created";function y(){return`<li>
  ...
  `}function $(e){const t=[];return e.forEach(a=>{t.push(S(a))}),t}function k(){i("#board-list"),o("#board-list",`
   ...
   `),w.from(".sorry",{y:30,opacity:0,duration:.2})}function j(e){if(e.length<1){k();return}i("#board-list"),o("#board-list",e.join(""))}function C(e){const t=[];return e.interestsState!=="all"&&t.push(`category = "${e.interestsState}"`),t.join("&&")}async function c(){if(!h())return;i("#board-list"),o("#board-list",y());const e=C(g);try{const t=await d.collection("qAndA").getFullList({sort:l,filter:e});j($(t))}catch{alert("서버 통신을 하는 도중 오류가 발생했습니다. 잠시후 다시 시도해주세요.")}}c();const L=b(".category-button");function T({target:e}){const{id:t}=e;g.interestsState=t,c()}L.forEach(e=>{e.addEventListener("change",T)});const q=v("#sort");function A(e=1e3){let t=!0,a=!1;return s=>{a?alert("성격이 급하신 것 같아요. 천천히 눌러주세요~"):(t?(s.currentTarget.textContent="오래된 작성 순",s.currentTarget.classList.replace("bg-direction-icon","bg-direction_rotate-icon"),l="+created"):(s.currentTarget.textContent="최근 작성 순",s.currentTarget.classList.replace("bg-direction_rotate-icon","bg-direction-icon"),l="-created"),t=!t,c()),a=!0,setTimeout(()=>{a=!1},e)}}q.addEventListener("click",A());
