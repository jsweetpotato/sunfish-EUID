import"./tailwind-Via4wZBX.js";import{g as O}from"./index-LZz_RBWS.js";import{g as b}from"./getNode-pa7syr6m.js";import{i as f}from"./insert-c9FKGVoP.js";import{c as x}from"./clear-vWyKvuJ4.js";import{p as r}from"./delay-L14dHocY.js";import{c as T}from"./checkAuth-CTdHH8Oq.js";import{b as g,c as u,a as C}from"./Modal-LwrVZ11o.js";const E={프로젝트:"💻",스터디:"📝",음식:"🍝","취미/여가":"🎧",운동:"⚽",독서:"📚"};function j(e){const{category:t,isOpen:o,title:n,date:a,description:s,members:c,maxMember:l}=e;let{age:i,gender:d}=e;const{id:P,avatar:$,name:v}=e.expand.user,k=o?"모집중":"모집완료",M=o?"text-secondary":"text-contents-content-secondary";d=d==="누구나"?`${d} 참여가능`:`${d}만 참여가능`,i=i==="모든 연령"?i:`${i}대`;const p=r.files.getUrl(e.expand.user,$,{thumb:"0x50"}),h=c.indexOf(r.authStore.model.id)>-1,L=`
